...
void Firing::Update() {
	if (!done) {
		...
		case 0:
			...
			break;
		case 1:
			if (current_millis - previous_millis > 750) { //Remmebr to change that number if necessary
		...
		case 2:
			...
			break;
		case 3:
			if (current_millis - previous_millis > 3500) {
     ...
     break;
		case 5:
			if (current_millis - previous_millis > 7000) {
